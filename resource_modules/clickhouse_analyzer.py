    ...
    def analyze_clickhouse_resources(self):
        ...
        for instance in all_instances:
            ...
            if self.is_clickhouse_idle(metrics):
                ...
                optimization = self.get_optimization_suggestion(metrics, instance.get('DBInstanceClass', ''))
                monthly_cost = self.get_monthly_cost(instance_id, instance.get('DBInstanceClass', ''), instance['Region'])
