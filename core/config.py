...
class CloudAccount:
    """云账号配置"""
    def __init__(self, name: str, provider: str, access_key_id: str, access_key_secret: str = None, region: str = None):
        self.name = name
...
class ConfigManager:
    ...
    def add_account(self, name: str, provider: str, access_key_id: str, 
                    access_key_secret: str, region: str = None):
        """
        添加账号配置
