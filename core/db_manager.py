...
class DatabaseManager:
    ...
    def save_instance(self, resource_type: str, instance: Dict[str, Any], 
        ...
        """
        table_name = f"{resource_type}_instances"
        instance_id = instance.get(instance_id_key) or instance.get('DBInstanceId') or instance.get('InstanceId')
        
        if not instance_id:
            return
        
        # 准备数据
        columns = ['instance_id', 'instance_name', 'instance_type', 'region', 
                  'status', 'creation_time', 'expire_time', 'monthly_cost']
        values = [
            instance_id,
    ...
    def save_instances_batch(self, resource_type: str, instances: List[Dict[str, Any]],
                            instance_id_key: str = 'InstanceId'):
        """
        批量保存资源实例
    ...
    def save_metric(self, resource_type: str, instance_id: str, 
    ...
    def save_metrics_batch(self, resource_type: str, instance_id: str,
    ...
    def get_metrics(self, resource_type: str, instance_id: str,
