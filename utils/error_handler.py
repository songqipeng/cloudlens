...
class ErrorHandler:
    ...
    def handle_api_error(
        e: Exception, resource_type: str, region: str = None, instance_id: str = None
    ) -> Optional[Exception]:
        """
        处理API错误
    ...
    @staticmethod
    def wrap_function(
        func: Callable, resource_type: str, error_handler: Optional[Callable] = None
    ) -> Callable:
        """
        包装函数，自动处理错误
